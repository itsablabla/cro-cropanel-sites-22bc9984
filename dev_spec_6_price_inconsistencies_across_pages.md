# Price inconsistencies across pages — dev spec
...
## Current state
notes: Prices differ across pages.

## Required change
notes: Standardize price display.

## Acceptance criteria
- GIVEN a first-time visitor on the affected page
- WHEN the change is live
- THEN Standardize price display.
- AND no layout regression at 375px / 768px / 1280px
- AND the changed control is keyboard-reachable with an accessible name

## Tracking
- Fire `cro_price_inconsistencies_across_pages` on interaction with the changed element
